...
function pixel(x, y, color = 'red') {
    ...
    context.fillRect(x * screen.scale + screen.scale / 2 - 2,
        y * screen.scale + screen.scale / 2, 4, 4);
}
...
BBBBBBBBB BB BB BBBSBBB BB BB BBBBBBBBBB
...
B BBBB BBBBB BBBBBBBBBBBBB BBBBB BBBB BB
B BBBB            BBB            BBBB BB
...
let keyLeft = false;
let keyDown = false;
document.addEventListener('keydown', function (event) { // клики на клавиатуре
    switch (event.which) {
        case 39:
        case 68:
            keyRight = true;
...
document.addEventListener('keyup', function (event) { // клики на клавиатуре
    switch (event.which) {
        case 39:
        case 68:
            keyRight = false;
